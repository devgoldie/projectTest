 ...
 * @author htp06
 */
@WebServlet(name = "ShowCustomerDetailServlet", urlPatterns = {"/ShowCustomerDetailServlet"})
public class ShowCustomerDetailServlet extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            CustomerAddress cusAdd = customerAddressFacade.find(id);
